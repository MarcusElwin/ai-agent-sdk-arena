...
const ItineraryDisplay: React.FC<ItineraryDisplayProps> = ({ itinerary, framework }) => {
  const [activeTab, setActiveTab] = useState<'transportation' | 'accommodation' | 'activities'>(
    'transportation'
  );
        ...
        >
          <div
            style={{
              ...
              color:
                activeTab === 'transportation' ? 'var(--primary-blue)' : 'var(--text-secondary)',
              fontWeight: '500',
              cursor: 'pointer',
              display: 'flex',
              alignItems: 'center',
            ...
            style={{
              ...
              borderBottom:
                activeTab === 'accommodation'
                  ...
                  : '2px solid transparent',
              color:
                activeTab === 'accommodation' ? 'var(--primary-blue)' : 'var(--text-secondary)',
              fontWeight: '500',
              cursor: 'pointer',
              display: 'flex',
              alignItems: 'center',
                        ...
                        >
                          <div>
                            ...
                            >
                              <Clock size={14} />
                              Duration:{' '}
                              {itinerary.transportation.outbound?.duration ||
                                'Details in itinerary'}
                            </div>
                          </div>
                          <div>
                            <div
                            ...
                            >
                              <DollarSign size={14} />
                              {itinerary.transportation.outbound?.cost
                                ? formatCurrency(itinerary.transportation.outbound.cost)
                                : 'Included'}
                            </div>
                          </div>
                        </div>
                        ...
                        >
                          <div>
                            ...
                            >
                              <Clock size={14} />
                              Duration:{' '}
                              {itinerary.transportation.inbound?.duration ||
                                itinerary.transportation.return?.duration ||
                                'Details in itinerary'}
                            </div>
                          </div>
                          <div>
                            ...
                            >
                              <DollarSign size={14} />
                              {itinerary.transportation.inbound?.cost ||
                              itinerary.transportation.return?.cost
                                ? formatCurrency(
                                    itinerary.transportation.inbound?.cost ||
                                      itinerary.transportation.return?.cost
                                  )
                  ...
                  <div style={{ padding: '1rem' }}>
                    ...
                    >
                      ...
                      <div style={{ textAlign: 'right' }}>
                        ...
                        >
                          <DollarSign size={14} />
                          {itinerary.accommodation.cost
                            ? formatCurrency(itinerary.accommodation.cost)
                            : 'See details in itinerary'}
                        </div>
                      ...
                      <div style={{ marginTop: '0.75rem', fontSize: '0.875rem' }}>
                        ...
                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
                          {Array.isArray(itinerary.accommodation.amenities) ? (
                            itinerary.accommodation.amenities.map(
              ...
              {itinerary.weather && (
                <div
                  style={{
                    ...
                    overflow: 'hidden',
                    background:
                      'linear-gradient(to right, rgba(25, 118, 210, 0.05), rgba(25, 118, 210, 0.1))',
                  }}
                >
                  <div style={{ padding: '1rem' }}>
                    <h3
