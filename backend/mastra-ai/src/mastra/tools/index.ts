...
export const accommodationSearchTool = createTool({
  ...
  inputSchema: z.object({
    ...
    propertyType: z
      .enum(['hotel', 'apartment', 'hostel', 'resort', 'any'])
      .default('any')
...
export const activitiesSearchTool = createTool({
  ...
  inputSchema: z.object({
    ...
    interests: z
      .array(z.string())
      .optional()
      .describe('Types of activities like museums, outdoors, food, etc.'),
...
const searchFlights = async (
  ...
  for (let i = 0; i < flightCount; i++) {
    ...
    const flightNumber =
      airline.substring(0, 2).toUpperCase() + Math.floor(Math.random() * 1000 + 100);
...
const searchActivities = async (
  ...
  const activityTemplates = [
    ...
    {
      name: `${location} Natural History Museum`,
      category: 'museum',
      price: 18,
      duration: '3 hours',
      familyFriendly: true,
    ...
    {
      name: `Historic ${location} Walking Tour`,
      category: 'tour',
      price: 30,
      duration: '3 hours',
      familyFriendly: true,
    ...
    {
      name: `${location} Nightclub Experience`,
      category: 'nightlife',
      price: 40,
      duration: '4 hours',
      familyFriendly: false,
    ...
    {
      name: `${location} Cultural Festival`,
      category: 'cultural',
      price: 35,
      duration: '6 hours',
      familyFriendly: true,
    ...
    {
      name: `${location} Wildlife Sanctuary`,
      category: 'outdoor',
      price: 28,
      duration: '4 hours',
      familyFriendly: true,
  ...
  const activities = shuffled.slice(0, activityCount).map(template => {
    ...
    const price =
      template.price === 0
        ? null
        : Math.round(template.price * (0.9 + Math.random() * 0.3) * 100) / 100;
